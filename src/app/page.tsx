    ...
    <div className="w-full h-screen bg-fir flex flex-col justify-start items-center relative overflow-hidden">
      ...
      <div className="relative z-20 w-full h-36 mt-24">
        <motion.p
          ...
          transition={{ duration: 0.5, ease: "easeInOut" }}
          className="text-9xl text-sec font-semibold absolute -top-16 left-1/4"
        >
          KOSH.
        </motion.p>
        <motion.p
          ...
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.5, ease: "easeInOut" }}
          className="text-9xl text-sec font-semibold absolute -bottom-16 right-1/4"
        >
          WALLET
        </motion.p>
      ...
      <motion.p
        ...
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.5, ease: "easeInOut" }}
        className="text-sec text-2xl mt-[7%] font-medium"
      >
      ...
      <motion.p
        ...
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.5, ease: "easeInOut" }}
        className="text-sec text-xl w-2/5 text-center font-regular"
      >
